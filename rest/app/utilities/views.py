...
from app.models.models import Document, Collateral, Conditions, Pages, Branches, HrPolicy, JobTranslations, Jobs, Footer, FloatMenu, FloatMenuSubmenus
...
from app.utilities.branch.serializers.read import BranchesReadSerializer
...
class BranchesViewSet(viewsets.ModelViewSet):
    queryset = Branches.objects.all().prefetch_related("branchphone_set")
    ...
    queryset = Branches.objects.all().prefetch_related(
        "branchphone_set"
    )
...
class FooterViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        serializer = FooterWriteSerializer(data=request.data)
    ...
    def update(self, request, *args, **kwargs):
        partial = kwargs.pop('partial', False)
        instance = self.get_object()
        serializer = FooterWriteSerializer(instance, data=request.data, partial=partial)
        serializer.is_valid(raise_exception=True)
        footer = serializer.save()
